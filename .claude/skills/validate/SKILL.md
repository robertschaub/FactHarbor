...
Before submitting jobs, `AGENTS.md` §Live Job Submission Discipline applies: commit relevant source/prompt/config changes, refresh/reseed/restart affected runtime state as needed, and monitor live jobs for failures, stale state, warnings/errors, and delays.

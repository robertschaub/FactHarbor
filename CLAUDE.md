...
- **Bugfixing**: load and apply `.claude/skills/debt-guard/SKILL.md` before editing any bugfix, regression, failing test/build, review finding, runtime defect, or failed-validation recovery.

...
1. ~~`Anthropic / Claude for Nonprofits`~~ ✅ Active since 2026-05-10
...
| `Cursor` | Editor tooling — **cancelled, ends Jun 6, 2026** | No public nonprofit program found | None for app runtime | [Pricing](https://cursor.com/pricing/), [Students](https://cursor.com/en-US/students), [Teams setup](https://docs.cursor.com/en/account/teams/setup) | **Cancelled** |

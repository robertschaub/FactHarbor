...
> _Adopted at the founding assembly on 23 April 2026. This is the statutes version in force._
...
### Article 1 — Name
Under the name **"FactHarbor"**, an association (Verein) is established in accordance with Articles 60 et seq. of the Swiss Civil Code (Schweizerisches Zivilgesetzbuch, ZGB).
...
1. **Founding Members** (Gründungsmitglieder) — the natural or legal persons who adopted these statutes at the founding assembly.
2. **Ordinary Members** (Ordentliche Mitglieder) — natural or legal persons admitted after the founding.
...
2. In particular, the Board:
   ...
   e. appoints and supervises team members and contractors;
   f. adopts policies, procedures, and regulations;
   g. manages the association's assets;
...
### Article 19 — Auditor
1. The General Assembly may appoint an Auditor (Revisionsstelle) for a term of one (1) year.
2. The Auditor reviews the annual financial statements and reports to the General Assembly.
3. If no Auditor is appointed, all members of the association may inspect the books and records upon reasonable notice.

---

## IV. Finances

### Article 20 — Funding Sources
1. The resources of the association are derived from:
   a. membership fees;
...
2. The following funding sources are **prohibited**:
   ...
   b. sale or rental of user data;
   c. payments conditioned on specific analytical outcomes (pay-for-rating);
   d. funding from sources that would compromise the independence or neutrality of the association;
   e. political or lobbying money.

### Article 21 — Fiscal Year
The fiscal year corresponds to the calendar year (1 January to 31 December).

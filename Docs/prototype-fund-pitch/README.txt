...
Provisional media (silent, with burned captions and a separate VTT track):
...
3. Replace the captions and the page transcript, remove the silent-provisional notice, and change the media query string to bypass caches.

...
- Next Claim Understanding dispatch gate: `Docs/WIP/2026-05-14_V2_Slice_6B3c_Dispatch_Integration_Review_Package.md`. Do not code dispatch until the package is reviewed and approved. The default next implementation should be contract/test-first unless Captain/deputies explicitly approve product runtime dispatch.

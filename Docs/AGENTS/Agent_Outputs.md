...
**Warnings:** This is hardening only. It does not authorize Query Planning execution, source/provider/search/fetch/parser/cache/SR/report/verdict/public/V1 work, live jobs, or public cutover. API-created hash nulls remain a separate provenance-observability follow-up before broader live/execution expansion.

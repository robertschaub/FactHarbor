...
| `plastic-en` | Must stay on the true side with adequate confidence — English-source evidence (~9% global recycling rate, ~51% of "recycled" plastic landfilled/incinerated, mechanical recycling not economically profitable) legitimately supports a true-side verdict. Bar corrected 2026-05-26 to match Phase 2 R3.1; previous false-side bar reflected a calibration drift. | `Plastic recycling is pointless` | MIXED / LEANING-TRUE / MOSTLY-TRUE; truth 40–75 (target 50–65; extreme >75 is a violation per Phase 2 R3.1); conf 55–85; min 2 boundaries |

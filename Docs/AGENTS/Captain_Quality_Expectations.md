...
| `plastic-en` | No fallback UNVERIFIED collapse from the old Stage 4 parse failure or the 2026-05-10 stale-watchdog failure. Operational failure is fixed; evidence/truth calibration remains open after current clean job `38655e2b60d24aaf93ea16d044d1a1c4` returned `MIXED` 52/68. | `Plastic recycling is pointless` | MOSTLY-FALSE / FALSE / MIXED; truth 10–35; conf 55–80; min 2 boundaries |
...
| `plastic-en` | `32f00bb32d644a909f0c99521e800536` — MOSTLY-FALSE 21/68 | No exact deployed match found | Local exact report remains the best comparator: 3 AtomicClaims and broad evidence. Current clean job `38655e2b60d24aaf93ea16d044d1a1c4` succeeded operationally but is not a best comparator because its `MIXED` 52/68 result is above the expected calibrated false-side truth band. Best visible deployed family variant is German `800431527e254d2888ef56ba23af4688` (`Plastik Recycling bringt nichts`, LEANING-FALSE 29/59), but it is not the canonical English input and should remain a variant control. |
...
| `plastic-en` | Operational failure is fixed by runner heartbeat commit `37554ace`: current clean job `38655e2b60d24aaf93ea16d044d1a1c4` completed instead of being stale-failed. Next work is no-edit report-quality review against comparator `32f00bb32d644a909f0c99521e800536`; do not spend another plastic job before localizing why the current truth score rose to 52. | No — control lane only |

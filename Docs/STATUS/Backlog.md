...
| **UPQ-1** | **Stage 2/3 upstream report quality stabilization**: new active quality workstream. Focus on claim-level evidence acquisition telemetry, query/event anchoring, evidence-pool quality, boundary concentration, and multilingual hard-family validation. Start with instrumentation and repeated canaries, then pick one bounded Stage 2 improvement slice before any Stage 3 clustering change. | Analyzer / Quality | high | high | ACTIVE | `Docs/WIP/2026-04-06_Upstream_Report_Quality_Workstream_Proposal.md`, `Docs/WIP/2026-04-04_Boundary_Concentration_and_Grounding_Stabilization_Plan.md` |

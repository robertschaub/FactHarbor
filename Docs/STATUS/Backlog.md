...
**Last Updated**: 2026-09-10 (EGA-LINK pointer row for Evidence-Gated Agents work)
...
| **EGA-LINK** | **Evidence-Gated Agents (Prototype Fund) work on the FactHarbor side** — isolated batch host and batch operation on a second exact-SHA checkout, C8 baseline, allowlist exporter, bundle and digest — is planned and tracked in the maintainer's separate Evidence-Gated Agents backlog. It does not restart the paused Alpha development plan and does not touch production. | Analyzer / Batch / Export | — | high | STANDING | Separately authorized; contingent on the programme outcome. |

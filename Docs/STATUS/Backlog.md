...
| ✅ **SR defaultScore fix (0.45→null)**: Root cause of Mar 12 TP regression. Unevaluated sources now excluded from weight calculation instead of being penalized. Gate 4 aligned. | SR / Quality | 2026-03-16 | Commit `a01577d8`, `Docs/WIP/SR_Evidence_Weighting_Investigation_2026-03-16.md` |

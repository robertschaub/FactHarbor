...
Current V2 source-acquisition state: 7A through 7N-3B3-1 are implementation-complete, and 7N-3B3-2A is approved as a docs-only parser/sink isolation boundary. 7N-3A source-IO authority/runtime-owner contracts are implemented at `18f0fa02`; 7N-3B source-IO preflight gate is documented at `05387362`; 7N-3B1 hidden/internal candidate-acquisition runtime shell is implemented at `878ba6ba`, post-review hardened at `3d05583e`, and consolidated in `Docs/WIP/2026-05-16_V2_Slice_7N3B1_Post_Implementation_Consolidation.md`; 7N-3B2 hidden/internal SDK-free candidate-provider network boundary is implemented at `54b8af1a` under `Docs/WIP/2026-05-16_V2_Slice_7N3B2_Candidate_Provider_Network_Source_Package.md`; 7N-3B3-1 hidden/internal content-dereference boundary is implemented at `267bfb9e` under `Docs/WIP/2026-05-16_V2_Slice_7N3B3-1_Content_Dereference_Source_Package.md` and consolidated in `Docs/WIP/2026-05-16_V2_Slice_7N3B3-1_Post_Implementation_Consolidation.md`; 7N-3B3-2A is approved in `Docs/WIP/2026-05-16_V2_Slice_7N3B3-2A_Parser_Sink_Isolation_Package.md`. 7N-3B3-1 is deliberately limited to a private content-dereference authority, raw-URL-free target and budget envelopes, branded HMAC-bound ephemeral execution targets, Node-core HTTPS content transport, DNS/final-address SSRF checks, IPv4-mapped IPv6 blocking, redirect denial, declared-vs-sniffed content-type mismatch rejection, byte/decompression caps, timeout/abort handling, and sanitized hidden diagnostics. It does not approve product/orchestrator/runner/API/UI/report/export wiring, live jobs, cache IO, Source Reliability, parser/sink source implementation, ACS/direct URL runtime dispatch, prompt/config/model/schema changes, public result exposure, evidence/report generation, real transport-byte handoff, or V1 cleanup.

Next V2 action: deputy review of `Docs/WIP/2026-05-16_V2_Slice_7N3B3-2B_Parser_Sink_Source_Package.md`. It is a draft source package only; source implementation remains blocked until review approval. 7N-3B3-2B must remain fixture/control-only unless a later 7N-3B3-2C source envelope explicitly includes a narrow owner-only real-byte handoff edit to `source-acquisition-content-transport.ts`. Parser/sink source implementation, real byte handoff, live jobs, product/public wiring, cache/SR integration, evidence/report generation, and V1 cleanup remain blocked. Captain-approved future direct-text canaries are `Mehr als 235 000 Personen aus dem Asylbereich sind zurzeit in der Schweiz` and `Did the legal proceedings against Jair Bolsonaro comply with Brazilian law, and did the proceedings and the verdicts meet international standards for a fair trial?`; do not run or substitute them until a reviewed executable/live-smoke gate makes live jobs meaningful. `Plastic recycling is pointless` `blocked/no_valid_claim` remains a separate Claim Understanding policy-quality review item.

...
- **X7-T/X7-T-R setup failures and X7-T-S final launcher-exact smoke addendum:** X7-T job `878828510c034cf7a72af502c38e48bd` and X7-T-R job `c800a7e695114765bc27bff79be10543` both failed closed before V2 preparation with `v2-shell-disabled`, so neither is a Query Planning runtime sample. The precise launcher quoting cause is now diagnosed by a disposable non-secret exact-gate probe. `Docs/WIP/2026-05-17_V2_Slice_X7-T-S_Final_Launcher_Exact_Gate_Smoke_Addendum.md` is the final docs-only setup-recovery addendum: after commit, exact-gate launcher probe, corrected runtime refresh, actual port-3000 process proof, route preflight, and idle checkpoint, it may submit exactly one German canary. It does not authorize the English canary, additional live jobs, source/search/fetch/parser/SR/cache IO, EvidenceCorpus/evidence/report/verdict/warning/confidence behavior, prompt/config/model/schema edits, public cutover, ACS/direct URL, V1 reuse, or V1 cleanup.

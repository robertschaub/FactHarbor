...
**Current source-acquisition note:** X7-E is now the latest hidden direct-text source-acquisition composition hardening slice; it makes X7-D consume the X6-P provenance reader and reject copied/non-runtime-owned X6 inputs before downstream readiness.

...
Source reliability is an observable source-trust signal in V2. Direct truth-percentage weighting by source reliability is not adopted by default and requires later deputy review, comparator evidence, and tests.
...
- comparator review must use Captain-defined benchmark inputs and best available historical reports;

...
| **LiveCheck & Innosuisse** | [**Innosuisse Application Guide**](Innosuisse_Bewerbung_Leitfaden.md) | Public guidance for the Swiss funding route and how LiveCheck-class proposals fit the current Innosuisse / DIZH path. |
...
| **Swiss research cooperation stack** | [**Cooperation Opportunities**](<../xwiki-pages/FactHarbor/Organisation/Strategy/Cooperation Opportunities/WebHome.xwiki>) | Public current Swiss partner sequence: ZHAW first, then DACH pilot outreach and later EBU / Full Fact routes. |

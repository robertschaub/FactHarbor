...
| **2** | **Instrument failure modes** — track refusal/degradation rates by topic, provider, stage. Detect C18 (refusal asymmetry) | Low | 🟠 **High** — reveals invisible bias | 🟠 **Partial** |

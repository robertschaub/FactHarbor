...
> 
> **xWiki file**: `Docs/xwiki-pages/FactHarbor_Spec_and_Impl/FactHarbor/Specification/Development/Guidelines/Scope Definition Guidelines/WebHome.xwiki`
> 
...
**Related**: [TERMINOLOGY.md](../REFERENCE/TERMINOLOGY.md), [AGENTS.md](../../AGENTS.md)
...
2. [EvidenceScope](#2-evidencescope)
3. [AnalysisContext](#3-analysiscontext)
...
2. **Explain verdicts** by showing which methodologies contributed
3. **Detect conflicting methodologies** (same claim, different measurement boundaries)

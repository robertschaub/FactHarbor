...
- [2026-04-07_UPQ1_Phase_A2_Canary_Measurement.md](2026-04-07_UPQ1_Phase_A2_Canary_Measurement.md) — claim-level acquisition telemetry results, seeded-evidence dominance finding, and local-vs-deployed check for `b130d00c`
- [2026-04-06_Cross_Boundary_Tension_Investigation.md](2026-04-06_Cross_Boundary_Tension_Investigation.md) — supporting debate / implementation-plan note for the Stage 5 narrative-tension fix sequence
- [2026-04-06_Upstream_Report_Quality_Workstream_Proposal.md](2026-04-06_Upstream_Report_Quality_Workstream_Proposal.md) — next quality track proposal: move from Stage 5 narrative cleanup to Stage 2/3 evidence-pool quality, query anchoring, and boundary concentration stabilization

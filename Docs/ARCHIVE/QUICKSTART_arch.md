> _Archived from [QUICKSTART.md](../../QUICKSTART.md) on 2026-09-23. This is the full January 2026 version, from before the baseline and A/B test runners were deleted (`28323efce`) and the Orchestrated-era metrics hooks, manual migration step and unused environment variables were removed. It describes the pre-ClaimAssessmentBoundary setup; do not follow it._

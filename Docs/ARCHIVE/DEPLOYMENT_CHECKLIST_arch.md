> _Archived from [DEPLOYMENT_CHECKLIST.md](../../DEPLOYMENT_CHECKLIST.md) on 2026-09-23. This is the full v2.8.1 (2026-01-19) checklist, including the 2026-03-10 search-cache and source-reliability notes, from before the manual migration options, the Orchestrated-era metrics and performance instructions and the baseline and A/B test runners (deleted in `28323efce`) were removed. Do not follow it._

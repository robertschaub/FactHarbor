...
> 
> **xWiki file**: `Docs/xwiki-pages/FactHarbor_Spec_and_Impl/FactHarbor/User Guides/LLM Configuration/WebHome.xwiki`
> 
...
| Fact extraction | Claude Haiku | ~75% cheaper (70% model + estimated 20-30% prompt optimization) |

...
When the selected AtomicClaim uses categorical or absolute wording about value, usefulness, effectiveness, existence, legality, fairness, or causal relation, calibrate the verdict against the whole categorical assertion. Evidence of limited performance, inefficiency, incompleteness, caveats, process barriers, or a pending procedural posture can support a caveated same-side candidate, but it should not by itself justify a strong same-side label for the whole categorical assertion when the cited evidence or uncertainty signals leave material countervailing value, benefit, compliance, support, or unresolved scope, including unresolved source-attributed usefulness. Conversely, evidence of some countervailing value or caveat should not flip the whole claim unless it materially addresses the same claim relation. Use calibrated labels, truth percentages, confidence, caveats, and material uncertainty signals to preserve nuance.

...
When the selected AtomicClaim uses categorical or absolute wording about value, effectiveness, existence, legality, fairness, or causal relation, calibrate the verdict against the whole categorical assertion. Evidence of limited performance, inefficiency, incompleteness, caveats, or a pending procedural posture can support a caveated same-side candidate, but it should not by itself justify the strongest same-side label for the whole categorical assertion when supplied evidence also shows material countervailing value, benefit, compliance, support, or unresolved scope. Conversely, evidence of some countervailing value or caveat should not flip the whole claim unless it materially addresses the same claim relation. Use calibrated labels, truth percentages, confidence, caveats, and material uncertainty signals to preserve nuance.

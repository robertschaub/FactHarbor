...
description: "Verdict validation for inversion/counter-claim/harm detection"
...
Your task is to detect inversions, counter-claims, harm potential, and contestation.

Mode: ${MODE}
- "full": Perform all validation checks
- "harm_potential_only": Only assess harm potential (skip inversion/counter-claim)
...
### Counter-Claim Detection (skip if MODE != "full")
- Is this claim OPPOSING the thesis? (counter-claim)
- Counter-claims should have inverted contribution to overall verdict
- Identify polarity:
  - supports_thesis: Evidence supports the main thesis
  - opposes_thesis: Evidence contradicts the main thesis
  - neutral: Neither clearly supports nor opposes
...
For harm_potential_only mode, omit inversion and counter-claim fields:
{

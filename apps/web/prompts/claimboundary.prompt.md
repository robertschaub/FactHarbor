...
lastModified: "2026-04-19T15:20:00Z"
variables:
  - currentDate
  - analysisInput
  - originalClaim
...
- **Per-side direct-evidence sufficiency for comparative ecosystems (MANDATORY).**
  - When the claim compares whether an activity is systematic, institutionalized, organized, or otherwise established across two or more jurisdictions or entities, assess each side's direct ecosystem evidence separately before resolving the comparison.

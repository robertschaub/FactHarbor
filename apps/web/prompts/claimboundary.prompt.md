...
2. For rule-governed standard claims, role facts, objections, criticism, concern, appearance-risk material, alleged coordination, adjacent controversies, and broader institutional context are not directional unless the item itself records the same target's safeguard/remedy action, operative outcome, or standards conclusion.

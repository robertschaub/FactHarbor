...
lastModified: "2026-04-19T14:45:00Z"
variables:
  - currentDate
  - analysisInput
  - originalClaim
...
- First, classify the input as one of:
  ...
  - **Exclusivity/uniqueness override:** If the input asserts that a subject is the sole, only, first, or last member of a class to have (or lack) a property, classify as `multi_assertion_input`. Such claims logically bundle two independently verifiable assertions: (a) the subject has (or lacks) the stated property, and (b) no other member of the stated class shares that status. These require different evidence to verify and can be independently true or false. Decompose into one claim per independent assertion: one for the subject-specific property and one for the exclusivity/universality across the class.
...
- First, classify the original input. **Before applying the four classification types below, check for the Plurality override:**
  ...
  - **Exclusivity/uniqueness override:** If the input asserts that a subject is the sole, only, first, or last member of a class to have (or lack) a property, classify as `multi_assertion_input`. Such claims logically bundle two independently verifiable assertions: (a) the subject has (or lacks) the stated property, and (b) no other member of the stated class shares that status. These require different evidence to verify and can be independently true or false. Decompose into one claim per independent assertion: one for the subject-specific property and one for the exclusivity/universality across the class. Each decomposed claim must be a genuine sub-assertion — not a verbatim copy of the full input.
  - **multi_assertion_input**: multiple distinct verifiable assertions.

...
- For rule-governed compliance claims, treat non-controlling procedural positions as contestation context, not established rule outcomes. A dissenting or minority vote, unsuccessful procedural motion, rejected objection, or participant position is `contextual` unless the claim asks whether that position existed or the source reports a controlling or legally effective ruling, disposition, remedy, annulment, or other operative rule outcome on that position. Preserve the non-controlling or legally effective status in the extracted statement.

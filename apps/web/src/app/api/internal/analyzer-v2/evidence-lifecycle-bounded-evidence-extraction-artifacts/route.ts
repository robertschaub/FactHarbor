...
import {
  BOUNDED_EVIDENCE_EXTRACTION_ARTIFACT_MAX_LEDGER_ID_LENGTH,
...
function readLedgerId(req: Request): string | null {
  ...
  if (
    ...
    ledgerId.length > BOUNDED_EVIDENCE_EXTRACTION_ARTIFACT_MAX_LEDGER_ID_LENGTH ||
...
export async function GET(req: Request) {
  ...
  const artifacts = readBoundedEvidenceExtractionRuntimeArtifactDefaultProjections(ledgerId);

...
import {
  EVIDENCE_LIFECYCLE_EXTRACTION_INPUT_ARTIFACT_MAX_LEDGER_ID_LENGTH,
...
export async function GET(req: Request) {
  ...
  const artifacts = readEvidenceLifecycleExtractionInputRuntimeArtifactDefaultProjections(ledgerId);

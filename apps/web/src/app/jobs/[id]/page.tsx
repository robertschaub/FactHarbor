...
export default function JobPage() {
  ...
  // PR 2 (Rev B Track 2): cellVerdicts and claimLevelVerdicts memos were
  // removed. The coverage matrix is now count-only — verdict colors lived only
  // in the matrix and confused the count vs. verdict semantics. If a verdict-
  // oriented matrix is wanted, build a separate component.

...
const WARNING_TYPE_LABELS: Record<string, string> = {
  ...
  selected_claim_zero_acquisition: "Selected Claim Not Researched",
...
const WARNING_TYPE_HINTS: Record<string, string> = {
  ...
  selected_claim_zero_acquisition: "A selected AtomicClaim reached the verdict path without any provider search attempt. Treat the affected verdict as degraded and rerun after adjusting research budget or selection scope.",

...
const WARNING_TYPE_LABELS: Record<string, string> = {
  ...
  insufficient_direct_evidence: "Insufficient Direct Evidence (F4)",
  ...
  evidence_applicability_assessment_degraded: "Applicability Assessment Degraded",
...
const WARNING_TYPE_HINTS: Record<string, string> = {
  ...
  evidence_applicability_assessment_degraded: "Rerun after provider/config health is restored; direct evidence eligibility could not be fully assessed.",
  ...
  insufficient_direct_evidence: "This claim lacks claim-local direct evidence that can be cited for a publishable verdict.",

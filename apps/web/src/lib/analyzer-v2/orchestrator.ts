...
function buildAdminStopReportMarkdown(summary: AdminStopSummary): string {
  return [
    ...
    "",
    ...summary.observations.slice(0, 16),
    "",
    "## Next Step",
    "",
    summary.nextStep,
    ...
    try {
      ...
      if (runtimeConfigSnapshot) {
        ...
        setAdminStopSummary({
          ...
          observations: [
            boundedObservation("Source Material records", sourceMaterialPageSummary.sourceMaterialRecordCount),
            boundedObservation("W4-G bounded text", evidenceCorpusBoundedTextAuthorization.status),
            boundedObservation("W4-G stop", evidenceCorpusBoundedTextAuthorization.stopReason),
            boundedObservation("W4-G sidecars", evidenceCorpusBoundedTextAuthorization.boundedTextSidecarCount),
            boundedObservation("W4-H extraction input", extractionInputAuthorization.status),
            boundedObservation("W4-H stop", extractionInputAuthorization.stopReason),
            boundedObservation("W4-H packets", extractionInputAuthorization.extractionInputPacketCount),
            boundedObservation("W4-I readiness", executionReadinessDenial.status),
            boundedObservation("W4-I stop", executionReadinessDenial.stopCondition),
            boundedObservation("W5 execution", boundedEvidenceExtraction.status),
            boundedObservation("W5 blocked", boundedEvidenceExtraction.blockedReason),
            boundedObservation("W5 damaged", boundedEvidenceExtraction.damagedReason),

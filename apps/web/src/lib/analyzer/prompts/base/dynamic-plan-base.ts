...
**AnalysisContext**: Top-level bounded analytical frame requiring separate investigation and verdict
...
4. If a clear article framing is present, note it explicitly.
...
Generic by Design: Do not assume domain-specific claims without verification.

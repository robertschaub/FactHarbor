...
const analyzerV2EvidenceLifecycleEvidenceCorpusObservabilityArtifactInspectionRoutePath = path.resolve(
  appRoot,
  "api/internal/analyzer-v2/evidence-lifecycle-evidence-corpus-observability-artifacts/route.ts",
);
const analyzerV2EvidenceLifecycleEvidenceCorpusBoundedTextArtifactInspectionRoutePath = path.resolve(
  appRoot,
...
const analyzerV2EvidenceLifecycleInternalAlphaReportResultArtifactInspectionRoutePath = path.resolve(
  appRoot,
...
const analyzerV2EvidenceLifecycleInternalReportWriterArtifactInspectionRoutePath = path.resolve(
  appRoot,
  "api/internal/analyzer-v2/evidence-lifecycle-internal-report-writer-artifacts/route.ts",
);
...
const evidenceLifecycleEvidenceCorpusShellPath = path.resolve(
  evidenceLifecycleEvidenceCorpusRoot,
  "evidence-corpus-shell.ts",
);
const evidenceLifecycleEvidenceCorpusExtractionReadinessDenialPath = path.resolve(
  evidenceLifecycleEvidenceCorpusRoot,
  "evidence-corpus-extraction-readiness-denial.ts",
);
...
const evidenceLifecycleExecutionReadinessDenialPath = path.resolve(
  evidenceLifecycleExecutionReadinessRoot,
  "execution-readiness-denial.ts",
);
const evidenceLifecycleBoundedEvidenceExtractionPath = path.resolve(
...
const evidenceLifecycleSufficiencyAssessmentPath = path.resolve(
  evidenceLifecycleSufficiencyRoot,
...
const evidenceLifecycleAggregationNarrativeContractPath = path.resolve(
  evidenceLifecycleReportResultRoot,
  "aggregation-narrative-contract.ts",
);
const evidenceLifecycleInternalReportWriterPath = path.resolve(
  evidenceLifecycleReportResultRoot,
  "internal-report-writer.ts",
);
...
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusSourceMaterialAdmissionProvenancePath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-evidence-corpus-source-material-admission-provenance.ts",
);
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellOwnerPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-evidence-corpus-shell-owner.ts",
);
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellProvenancePath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-evidence-corpus-shell-provenance.ts",
);
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusExtractionReadinessDenialOwnerPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-evidence-corpus-extraction-readiness-denial-owner.ts",
);
...
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusObservabilityArtifactSinkPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-evidence-corpus-observability-artifact-sink.ts",
);
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextAuthorizationOwnerPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-evidence-corpus-bounded-text-authorization-owner.ts",
);
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextAuthorizationProvenancePath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-evidence-corpus-bounded-text-authorization-provenance.ts",
);
...
const analyzerV2RuntimeEvidenceLifecycleExecutionReadinessDenialOwnerPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-execution-readiness-denial-owner.ts",
);
const analyzerV2RuntimeEvidenceLifecycleExecutionReadinessDenialProvenancePath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-execution-readiness-denial-provenance.ts",
);
const analyzerV2RuntimeEvidenceLifecycleExecutionReadinessArtifactSinkPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-execution-readiness-artifact-sink.ts",
);
const analyzerV2RuntimeEvidenceLifecycleBoundedEvidenceExtractionOwnerPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-bounded-evidence-extraction-owner.ts",
);
const analyzerV2RuntimeEvidenceLifecycleBoundedEvidenceExtractionProvenancePath = path.resolve(
  analyzerV2RuntimeRoot,
...
const analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-internal-report-writer-owner.ts",
);
const analyzerV2RuntimeEvidenceLifecycleInternalReportWriterArtifactSinkPath = path.resolve(
  analyzerV2RuntimeRoot,
  "evidence-lifecycle-internal-report-writer-artifact-sink.ts",
);
...
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusObservabilityArtifactSinkApprovedImports =
  new Map<string, Set<string>>([
    [
      "./evidence-lifecycle-evidence-corpus-extraction-readiness-denial-owner",
      new Set(["EvidenceLifecycleEvidenceCorpusExtractionReadinessDenialDecision"]),
    ],
    [
      "./evidence-lifecycle-evidence-corpus-shell-owner",
      new Set(["EvidenceLifecycleEvidenceCorpusShellDecision"]),
    ],
    [
      "./evidence-lifecycle-evidence-corpus-source-material-admission-owner",
      new Set(["EvidenceLifecycleEvidenceCorpusSourceMaterialAdmissionDecision"]),
    ],
    [
      "@/lib/analyzer-v2/run-context",
      new Set(["PipelineRunContext"]),
...
const analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextArtifactSinkApprovedImports =
  new Map<string, Set<string>>([
    [
      "./evidence-lifecycle-evidence-corpus-bounded-text-authorization-owner",
      new Set(["EvidenceLifecycleEvidenceCorpusBoundedTextAuthorizationDecision"]),
    ],
    [
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/bounded-text-authorization",
      new Set(["EvidenceCorpusBoundedTextSidecar"]),
    ],
    [
      "@/lib/analyzer-v2/run-context",
      new Set(["PipelineRunContext"]),
...
const analyzerV2RuntimeEvidenceLifecycleExecutionReadinessArtifactSinkApprovedImports =
  new Map<string, Set<string>>([
    [
      "@/lib/analyzer-v2/run-context",
      new Set(["PipelineRunContext"]),
    ...
    [
      "@/lib/analyzer-v2/evidence-lifecycle/execution-readiness/execution-readiness-denial",
      new Set([
    ...
    [
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-execution-readiness-denial-provenance",
      new Set([
...
const analyzerV2RuntimeEvidenceLifecycleBoundedEvidenceExtractionArtifactSinkApprovedImports =
  new Map<string, Set<string>>([
    [
      "@/lib/analyzer-v2/run-context",
      new Set(["PipelineRunContext"]),
...
const analyzerV2RuntimeProductImportApprovedPaths = new Map<string, Set<string>>([
  [
    ...
    new Set([
      ...
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-evidence-corpus-shell-owner",
      ...
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-execution-readiness-denial-owner",
      ...
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-internal-report-writer-owner",
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-internal-report-writer-artifact-sink",
    ]),
  ],
  [
    toPosix(analyzerV2EvidenceLifecycleBoundedEvidenceExtractionArtifactInspectionRoutePath),
    new Set([
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-bounded-evidence-extraction-artifact-sink",
    ]),
  ],
  ...
  [
    toPosix(analyzerV2EvidenceLifecycleInternalReportWriterArtifactInspectionRoutePath),
    new Set([
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-internal-report-writer-artifact-sink",
    ]),
  ],
  ...
  [
    ...
    new Set([
      ...
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-source-material-evidence-corpus-readiness-provenance",
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-evidence-corpus-source-material-admission-provenance",
    ]),
  ],
  [
    toPosix(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusSourceMaterialAdmissionProvenancePath),
    new Set([
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/source-material-admission",
      "node:crypto",
    ]),
  ...
  [
    toPosix(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellOwnerPath),
    new Set([
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/evidence-corpus-shell",
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-evidence-corpus-source-material-admission-provenance",
    ]),
  ],
  [
  ...
  [
    toPosix(analyzerV2RuntimeEvidenceLifecycleExecutionReadinessDenialOwnerPath),
    new Set([
      "@/lib/analyzer-v2/evidence-lifecycle/execution-readiness/execution-readiness-denial",
      "@/lib/analyzer-v2/evidence-lifecycle/extraction-input/bounded-extraction-input-authorization",
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-extraction-input-authorization-provenance",
  ...
  [
    toPosix(analyzerV2RuntimeEvidenceLifecycleExecutionReadinessDenialProvenancePath),
    new Set([
      "@/lib/analyzer-v2/evidence-lifecycle/execution-readiness/execution-readiness-denial",
      "@/lib/analyzer-v2/util",
    ]),
  ...
  [
    toPosix(analyzerV2EvidenceLifecycleEvidenceCorpusObservabilityArtifactInspectionRoutePath),
    new Set([
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-evidence-corpus-observability-artifact-sink",
    ]),
  ],
  ...
  [
    toPosix(analyzerV2RuntimeEvidenceLifecycleInternalAlphaReportResultArtifactSinkPath),
    new Set([
...
function isApprovedProviderFactorySdkImport(filePath: string, specifier: string): boolean {
  ...
  return (
    ...
    || normalizedFilePath === toPosix(analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath)
  )
...
describe("analyzer-v2 boundary guard", () => {
  ...
  it("keeps X7-W2 candidate-provider network product-owned, hidden, and scoped to the approved provider boundary", () => {
    ...
    for (const requiredText of [
      ...
      "SOURCE_ACQUISITION_CANDIDATE_PROVIDER_NETWORK_PROVIDER_TIMEOUT_MS = 3000",
      "SOURCE_ACQUISITION_CANDIDATE_PROVIDER_NETWORK_TOTAL_TIMEOUT_MS = 18000",
  ...
  it("keeps X7-W4-C corpus admission hidden, text-free, W4-A-owned, and pre-corpus", () => {
    ...
    expect(admissionOwnerImports).toEqual([
      "./evidence-lifecycle-evidence-corpus-source-material-admission-provenance",
      "./evidence-lifecycle-source-material-evidence-corpus-readiness-provenance",
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/source-material-admission",
    ]);
  ...
  it("keeps X7-W4-D EvidenceCorpus shell hidden, text-free, W4-C-owned, and extraction-closed", () => {
    const violations: string[] = [];

    for (const requiredPath of [
      evidenceLifecycleEvidenceCorpusShellPath,
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusSourceMaterialAdmissionProvenancePath,
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellOwnerPath,
    ]) {
      expect(existsSync(requiredPath)).toBe(true);
    }
    ...
    for (const specifier of shellImports) {
      ...
      if (isV1AnalyzerImport(evidenceLifecycleEvidenceCorpusShellPath, specifier)) {
        violations.push(`W4-D pure shell imports V1 analyzer ${specifier}`);
      }
      if (
        isProviderSdkImport(specifier)
        || isCacheIoImport(specifier)
        ...
        violations.push(`W4-D pure shell imports forbidden dependency ${specifier}`);
      }
    }

    const admissionProvenanceImports = collectModuleSpecifiers(
      parseSource(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusSourceMaterialAdmissionProvenancePath),
    ).sort();
    expect(admissionProvenanceImports).toEqual([
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/source-material-admission",
      "node:crypto",
    ]);

    const shellOwnerImports = collectModuleSpecifiers(
      parseSource(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellOwnerPath),
    ).sort();
    expect(shellOwnerImports).toEqual([
      "./evidence-lifecycle-evidence-corpus-shell-provenance",
      "./evidence-lifecycle-evidence-corpus-source-material-admission-provenance",
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/evidence-corpus-shell",
    ]);

    const shellContent = readFileSync(evidenceLifecycleEvidenceCorpusShellPath, "utf8");
    const admissionProvenanceContent = readFileSync(
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusSourceMaterialAdmissionProvenancePath,
      "utf8",
    );
    const shellProvenanceContent = readFileSync(
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellProvenancePath,
      "utf8",
    );
    const shellOwnerContent = readFileSync(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellOwnerPath, "utf8");
    for (const requiredText of [
      ...
      if (!shellContent.includes(requiredText)) {
        violations.push(`W4-D pure shell missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      "new WeakMap<object, string>()",
      ...
      "evidence_corpus_construction_gate_closed",
      "blocked_precutover",
    ]) {
      if (!admissionProvenanceContent.includes(requiredText)) {
        violations.push(`W4-C admission provenance missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      ...
      if (!shellProvenanceContent.includes(requiredText)) {
        violations.push(`W4-D shell provenance missing required text ${requiredText}`);
      }
    }
    if (!shellOwnerContent.includes("markEvidenceLifecycleEvidenceCorpusShellRuntimeOwnedDecision")) {
      violations.push("W4-D shell owner does not mark W4-D shell provenance");
    }
    for (const forbiddenText of [
      "runEvidenceLifecycleSourceMaterialPageSummaryDecision",
      "readEvidenceLifecycleSourceMaterialPageSummaryRuntimeOwnedDecision",
      ...
      if (
        shellContent.includes(forbiddenText)
        || admissionProvenanceContent.includes(forbiddenText)
        || shellProvenanceContent.includes(forbiddenText)
        || shellOwnerContent.includes(forbiddenText)
      ) {
        violations.push(`W4-D EvidenceCorpus shell contains forbidden text ${forbiddenText}`);
      }
    }
    ...
    for (const sourcePath of publicSurfaceFiles) {
      for (const specifier of collectModuleSpecifiers(parseSource(sourcePath))) {
        if (
          specifier.includes("evidence-lifecycle-evidence-corpus-shell-owner")
          || specifier.includes("evidence-lifecycle-evidence-corpus-shell-provenance")
          || specifier.includes("evidence-lifecycle-evidence-corpus-source-material-admission-provenance")
        ) {
          violations.push(`${toPosix(path.relative(webRoot, sourcePath))} imports W4-D/W4-C provenance module ${specifier}`);
        }
      }
    }
  ...
  it("keeps X7-W4-E EvidenceCorpus extraction readiness denial hidden, W4-D-owned, and denial-only", () => {
    const violations: string[] = [];

    for (const requiredPath of [
      evidenceLifecycleEvidenceCorpusExtractionReadinessDenialPath,
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellProvenancePath,
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusExtractionReadinessDenialOwnerPath,
    ]) {
      expect(existsSync(requiredPath)).toBe(true);
    }

    const denialImports = collectModuleSpecifiers(
      parseSource(evidenceLifecycleEvidenceCorpusExtractionReadinessDenialPath),
    ).sort();
    expect(denialImports).toEqual(["./evidence-corpus-shell"]);
    for (const specifier of denialImports) {
      if (isAnalyzerV2RuntimeImport(evidenceLifecycleEvidenceCorpusExtractionReadinessDenialPath, specifier)) {
        violations.push(`W4-E pure denial imports runtime module ${specifier}`);
      }
      if (isV1AnalyzerImport(evidenceLifecycleEvidenceCorpusExtractionReadinessDenialPath, specifier)) {
        violations.push(`W4-E pure denial imports V1 analyzer ${specifier}`);
      }
      if (
        isProviderSdkImport(specifier)
        || isCacheIoImport(specifier)
        ...
        violations.push(`W4-E pure denial imports forbidden dependency ${specifier}`);
      }
    }

    const shellProvenanceImports = collectModuleSpecifiers(
      parseSource(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellProvenancePath),
    ).sort();
    expect(shellProvenanceImports).toEqual([
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/evidence-corpus-shell",
      "node:crypto",
    ]);

    const denialOwnerImports = collectModuleSpecifiers(
      parseSource(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusExtractionReadinessDenialOwnerPath),
    ).sort();
    expect(denialOwnerImports).toEqual([
      "./evidence-lifecycle-evidence-corpus-shell-provenance",
      "@/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/evidence-corpus-extraction-readiness-denial",
    ]);

    const denialContent = readFileSync(evidenceLifecycleEvidenceCorpusExtractionReadinessDenialPath, "utf8");
    const shellProvenanceContent = readFileSync(
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusShellProvenancePath,
      "utf8",
    );
    const denialOwnerContent = readFileSync(
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusExtractionReadinessDenialOwnerPath,
      "utf8",
    );
    for (const requiredText of [
      ...
      "evidence_item_extraction_denied_shell_only",
      "publicPointerExposure: \"forbidden\"",
      "semanticExtractionAuthorized: false",
      "evidenceItemExtractionAuthorized: false",
      "extractionInput: null",
      ...
      if (!denialContent.includes(requiredText)) {
        violations.push(`W4-E pure denial missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      "new WeakMap<object, string>()",
      ...
      if (!shellProvenanceContent.includes(requiredText)) {
        violations.push(`W4-E shell provenance missing required text ${requiredText}`);
      }
    }
    for (const forbiddenText of [
      "runEvidenceLifecycleSourceMaterialPageSummaryDecision",
      ...
      if (
        denialContent.includes(forbiddenText)
        || shellProvenanceContent.includes(forbiddenText)
        || denialOwnerContent.includes(forbiddenText)
      ) {
        violations.push(`W4-E extraction readiness denial contains forbidden text ${forbiddenText}`);
      }
    }
    ...
    for (const sourcePath of publicSurfaceFiles) {
      for (const specifier of collectModuleSpecifiers(parseSource(sourcePath))) {
        if (
          specifier.includes("evidence-lifecycle-evidence-corpus-extraction-readiness-denial-owner")
          || specifier.includes("evidence-lifecycle-evidence-corpus-shell-provenance")
        ) {
          violations.push(`${toPosix(path.relative(webRoot, sourcePath))} imports W4-E/W4-D runtime module ${specifier}`);
        }
      }
    }
  ...
  it("keeps X7-W4-F EvidenceCorpus observability product-routed, hidden, and denial-only", () => {
    const violations: string[] = [];

    for (const requiredPath of [
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusObservabilityArtifactSinkPath,
      analyzerV2EvidenceLifecycleEvidenceCorpusObservabilityArtifactInspectionRoutePath,
    ]) {
      expect(existsSync(requiredPath)).toBe(true);
    }

    const sinkSourceFile = parseSource(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusObservabilityArtifactSinkPath);
    for (const importBinding of collectImportBindings(sinkSourceFile)) {
      const approvedNames =
        analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusObservabilityArtifactSinkApprovedImports
          .get(importBinding.specifier);
      if (!approvedNames) {
        violations.push(`W4-F observability artifact sink imports unapproved module ${importBinding.specifier}`);
        continue;
      }
      for (const importedName of importBinding.names) {
        if (!approvedNames.has(importedName)) {
          violations.push(
            `W4-F observability artifact sink imports unapproved symbol ${importedName} from ${importBinding.specifier}`,
          );
        }
      }
    }
    ...
    for (const requiredText of [
      ...
      "evidenceCorpusSourceMaterialAdmission",
      "evidenceCorpusShell",
      ...
      if (!sinkContent.includes(requiredText)) {
        violations.push(`W4-F observability artifact sink missing required text ${requiredText}`);
      }
    }

    const routeImports = collectModuleSpecifiers(
      parseSource(analyzerV2EvidenceLifecycleEvidenceCorpusObservabilityArtifactInspectionRoutePath),
    ).sort();
    expect(routeImports).toEqual([
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-evidence-corpus-observability-artifact-sink",
      "@/lib/auth",
    ...
    for (const location of collectDirectFetchCallLocations(
      ...
      violations.push(`W4-F route makes direct fetch call at ${toPosix(path.relative(webRoot, location))}`);
    }
    ...
    for (const requiredSpecifier of [
      ...
      if (!orchestratorImports.includes(requiredSpecifier)) {
        violations.push(`orchestrator missing required W4-F import ${requiredSpecifier}`);
      }
    }

    for (const forbiddenText of [
      "sourceTextAuthorized: true",
      ...
      if (sinkContent.includes(forbiddenText)) {
        violations.push(`W4-F observability artifact sink contains forbidden text ${forbiddenText}`);
      }
    }
  ...
  it("keeps X7-W4-G bounded corpus text hidden, redacted by default, and extraction-closed", () => {
    const violations: string[] = [];

    for (const requiredPath of [
      evidenceLifecycleEvidenceCorpusBoundedTextAuthorizationPath,
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextAuthorizationOwnerPath,
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextAuthorizationProvenancePath,
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextArtifactSinkPath,
      analyzerV2EvidenceLifecycleEvidenceCorpusBoundedTextArtifactInspectionRoutePath,
    ]) {
      expect(existsSync(requiredPath)).toBe(true);
    }

    const sinkSourceFile = parseSource(analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextArtifactSinkPath);
    for (const importBinding of collectImportBindings(sinkSourceFile)) {
      const approvedNames =
        analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextArtifactSinkApprovedImports
          .get(importBinding.specifier);
      if (!approvedNames) {
        violations.push(`W4-G bounded text artifact sink imports unapproved module ${importBinding.specifier}`);
        continue;
      }
      for (const importedName of importBinding.names) {
        if (!approvedNames.has(importedName)) {
          violations.push(
            `W4-G bounded text artifact sink imports unapproved symbol ${importedName} from ${importBinding.specifier}`,
          );
        }
      }
    }

    const coreContent = readFileSync(evidenceLifecycleEvidenceCorpusBoundedTextAuthorizationPath, "utf8");
    const sinkContent = readFileSync(
      analyzerV2RuntimeEvidenceLifecycleEvidenceCorpusBoundedTextArtifactSinkPath,
      "utf8",
    );
    ...
    for (const requiredText of [
      ...
      "EVIDENCE_LIFECYCLE_EVIDENCE_CORPUS_BOUNDED_TEXT_ARTIFACT_MAX_SERIALIZED_BYTES = 32_768",
      ...
      if (!coreContent.includes(requiredText) && !sinkContent.includes(requiredText)) {
        violations.push(`W4-G bounded text implementation missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      ...
      if (!sinkContent.includes(requiredText) && !routeContent.includes(requiredText)) {
        violations.push(`W4-G bounded text default route projection missing required text ${requiredText}`);
      }
    }

    const routeImports = collectModuleSpecifiers(
      parseSource(analyzerV2EvidenceLifecycleEvidenceCorpusBoundedTextArtifactInspectionRoutePath),
    ).sort();
    expect(routeImports).toEqual([
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-evidence-corpus-bounded-text-artifact-sink",
      "@/lib/auth",
    ...
    for (const location of collectDirectFetchCallLocations(
      ...
      violations.push(`W4-G route makes direct fetch call at ${toPosix(path.relative(webRoot, location))}`);
    }
    ...
    for (const requiredSpecifier of [
      ...
      if (!orchestratorImports.includes(requiredSpecifier)) {
        violations.push(`orchestrator missing required W4-G import ${requiredSpecifier}`);
      }
    }
    ...
    for (const forbiddenText of [
      ...
      if (coreContent.includes(forbiddenText) || sinkContent.includes(forbiddenText) || routeContent.includes(forbiddenText)) {
        violations.push(`W4-G bounded text path contains forbidden text ${forbiddenText}`);
      }
    }
  ...
  it("keeps X7-W4-H extraction input hidden, redacted by default, and execution-closed", () => {
    ...
    for (const requiredText of [
      ...
      "BOUNDED_EXTRACTION_INPUT_APPROVED_PROVIDER_IDS = [",
      "\"openalex\"",
  ...
  it("keeps X7-W4-I execution-readiness denial hidden, redacted by default, and execution-closed", () => {
    const violations: string[] = [];

    for (const requiredPath of [
      evidenceLifecycleExecutionReadinessDenialPath,
    ...
    for (const importBinding of collectImportBindings(sinkSourceFile)) {
      const approvedNames =
        analyzerV2RuntimeEvidenceLifecycleExecutionReadinessArtifactSinkApprovedImports.get(importBinding.specifier);
      if (!approvedNames) {
        violations.push(`W4-I execution-readiness artifact sink imports unapproved module ${importBinding.specifier}`);
        continue;
      }
      for (const importedName of importBinding.names) {
        if (!approvedNames.has(importedName)) {
          violations.push(
            `W4-I execution-readiness artifact sink imports unapproved symbol ${importedName} from ${importBinding.specifier}`,
          );
        }
      }
    }
    ...
    for (const requiredText of [
      ...
      "x7w4i_no_extraction_execution_authority",
      ...
      if (!coreContent.includes(requiredText) && !sinkContent.includes(requiredText)) {
        violations.push(`W4-I execution-readiness implementation missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
    ...
    for (const requiredSpecifier of [
      ...
      if (!orchestratorImports.includes(requiredSpecifier)) {
        violations.push(`orchestrator missing required W4-I import ${requiredSpecifier}`);
      }
    }
  ...
  it("keeps X7-W5 bounded evidence extraction hidden, redacted by default, and pre-report", () => {
    const violations: string[] = [];
    ...
    for (const requiredPath of [
      ...
      analyzerV2EvidenceLifecycleBoundedEvidenceExtractionArtifactInspectionRoutePath,
    ]) {
      expect(existsSync(requiredPath)).toBe(true);
    }

    const sinkSourceFile = parseSource(analyzerV2RuntimeEvidenceLifecycleBoundedEvidenceExtractionArtifactSinkPath);
    for (const importBinding of collectImportBindings(sinkSourceFile)) {
      const approvedNames =
        analyzerV2RuntimeEvidenceLifecycleBoundedEvidenceExtractionArtifactSinkApprovedImports.get(
          importBinding.specifier,
        );
      if (!approvedNames) {
        violations.push(`W5 bounded evidence extraction artifact sink imports unapproved module ${importBinding.specifier}`);
        continue;
      }
      for (const importedName of importBinding.names) {
        if (!approvedNames.has(importedName)) {
          violations.push(
            `W5 bounded evidence extraction artifact sink imports unapproved symbol ${importedName} from ${importBinding.specifier}`,
          );
        }
      }
    }
    ...
    for (const requiredText of [
      "v2.evidence-lifecycle.bounded-evidence-extraction.x7w5",
      "bounded_evidence_extraction_execution",
      ...
      "merged_by_parity_rechecked_not_deleted",
      "first_positive_w5_executor_proof_plus_reviewed_followup",
      "defaultProjection: \"hash_length_provenance_only\"",
    ...
    for (const requiredText of [
      "Bounded Evidence Extraction provider call failed.",
      "generateText",
      "anthropic",
      "maxRetries: 0",
      ...
      if (!ownerContent.includes(requiredText)) {
        violations.push(`W5 bounded evidence extraction owner missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      "BOUNDED_EVIDENCE_EXTRACTION_ARTIFACT_MAX_SERIALIZED_BYTES = 32_768",
      "redacted_default_hash_length_provenance_only",
      "inputTextReturned: false",
      ...
      if (!sinkContent.includes(requiredText) && !routeContent.includes(requiredText)) {
        violations.push(`W5 bounded evidence extraction default route projection missing required text ${requiredText}`);
      }
    }

    const routeImports = collectModuleSpecifiers(
      parseSource(analyzerV2EvidenceLifecycleBoundedEvidenceExtractionArtifactInspectionRoutePath),
    ).sort();
    expect(routeImports).toEqual([
      "@/lib/analyzer-v2-runtime/evidence-lifecycle-bounded-evidence-extraction-artifact-sink",
      "@/lib/auth",
    ...
    for (const location of collectDirectFetchCallLocations(
      ...
      violations.push(`W5 route makes direct fetch call at ${toPosix(path.relative(webRoot, location))}`);
    }
    ...
    for (const requiredSpecifier of [
      ...
      if (!orchestratorImports.includes(requiredSpecifier)) {
        violations.push(`orchestrator missing required W5 import ${requiredSpecifier}`);
      }
    }
    ...
    for (const forbiddenText of [
      ...
      if (
        ...
        violations.push(`W5 bounded evidence extraction path contains forbidden text ${forbiddenText}`);
      }
    }
    for (const forbiddenRouteText of [
      "\"inputText\":",
      ...
      if (routeContent.includes(forbiddenRouteText)) {
        violations.push(`W5 default route references forbidden text surface ${forbiddenRouteText}`);
      }
    }
    ...
    for (const sourcePath of analyzerV2RuntimeSourceFiles) {
      ...
      for (const specifier of collectModuleSpecifiers(sourceFile)) {
        ...
        const isApprovedBoundaryVerdictPromptFileImport =
          ...
          && specifier === "node:fs/promises";
        const isApprovedInternalReportWriterPromptFileImport =
          toPosix(sourcePath) === toPosix(analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath)
          && specifier === "node:fs/promises";
        if (isV1AnalyzerImport(sourcePath, specifier)) {
        ...
        if (
          ...
          !isApprovedInternalReportWriterPromptFileImport
        ) {
  ...
  it("keeps provider SDK imports confined to approved runtime provider factories", () => {
    ...
    expect((
      importsByFactory.get(toPosix(analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath)) ?? []
    ).sort()).toEqual(["@ai-sdk/anthropic", "ai"]);
  });
  ...
  it("keeps W7-A/W7-B boundary/verdict owners isolated to their approved contracts", () => {
    ...
    const approvedImportsByFile = new Map<string, Map<string, Set<string>>>([
      [
        toPosix(evidenceLifecycleBoundaryVerdictCandidatePath),
        new Map<string, Set<string>>([
          [
            "@/lib/analyzer-v2/evidence-lifecycle/evidence-items/evidence-item-handoff",
    ...
    for (const sourcePath of boundaryVerdictFiles) {
      const sourceFile = parseSource(sourcePath);
      const sourceContent = readFileSync(sourcePath, "utf8");
      const relativePath = toPosix(path.relative(webRoot, sourcePath));
      ...
      for (const importBinding of collectImportBindings(sourceFile)) {
        ...
        if (!approvedNames) {
          violations.push(`${relativePath} imports unapproved W7-A dependency ${importBinding.specifier}`);
          continue;
        }
        for (const importedName of importBinding.names) {
          if (!approvedNames.has(importedName)) {
      ...
      const commonForbiddenText = [
        ...
        "boundaryLlmCalled: true",
        "verdictLlmCalled: true",
        "modelCalled: true",
        "reportGenerated: true",
        "verdictGenerated: true",
        "warningGenerated: true",
  ...
  it("keeps W8 internal Alpha report owners isolated and non-public", () => {
    ...
    expect(reportResultFiles.map((filePath) => toPosix(path.relative(webRoot, filePath))).sort()).toEqual([
      "src/lib/analyzer-v2/evidence-lifecycle/report-result/aggregation-narrative-contract.ts",
      ...
      "src/lib/analyzer-v2/evidence-lifecycle/report-result/internal-report-writer.ts",
    ...
    expect(existsSync(evidenceLifecycleAggregationNarrativeContractPath)).toBe(true);
    expect(existsSync(evidenceLifecycleInternalReportWriterPath)).toBe(true);

    const approvedImportsByFile = new Map<string, Map<string, Set<string>>>([
      [
        toPosix(evidenceLifecycleAggregationNarrativeContractPath),
        new Map<string, Set<string>>([
          [
            "zod",
            new Set(["z"]),
      ...
      [
        toPosix(evidenceLifecycleInternalAlphaReportResultPath),
        new Map<string, Set<string>>([
          [
            "@/lib/analyzer-v2/evidence-lifecycle/boundary-verdict/boundary-verdict-execution",
          ...
          [
            "@/lib/analyzer-v2/evidence-lifecycle/evidence-items/bounded-evidence-extraction",
            new Set(["BOUNDED_EVIDENCE_EXTRACTION_DECISION_VERSION", "BoundedEvidenceExtractionDecision"]),
          ],
          [
            "@/lib/analyzer-v2/evidence-lifecycle/evidence-items/evidence-item-handoff",
            new Set(["EvidenceItemHandoffDecision", "EVIDENCE_ITEM_HANDOFF_DECISION_VERSION"]),
          ...
          [
            "@/lib/analyzer-v2/evidence-lifecycle/report-result/report-stop-candidate",
            new Set(["INTERNAL_ALPHA_REPORT_STOP_DECISION_VERSION", "InternalAlphaReportStopCandidate"]),
          ],
          [
            "@/lib/analyzer-v2/evidence-lifecycle/sufficiency/sufficiency-assessment",
            new Set(["SufficiencyAssessmentDecision", "SUFFICIENCY_ASSESSMENT_DECISION_VERSION"]),
      ...
      [
        toPosix(evidenceLifecycleInternalReportWriterPath),
        new Map<string, Set<string>>([
          [
            "node:crypto",
            new Set(["createHash"]),
          ...
          [
            "@/lib/analyzer-v2/evidence-lifecycle/boundary-verdict/boundary-verdict-execution",
            new Set(["BoundaryVerdictExecutionDecision", "BoundaryVerdictExecutionInternalReviewPayload"]),
          ],
          [
            "@/lib/analyzer-v2/evidence-lifecycle/report-result/aggregation-narrative-contract",
            new Set([
    ...
    for (const sourcePath of reportResultFiles) {
      ...
      const isReportWriterSource = sourcePath === evidenceLifecycleInternalReportWriterPath;
      const isAggregationNarrativeContract = sourcePath === evidenceLifecycleAggregationNarrativeContractPath;
      ...
      for (const specifier of collectModuleSpecifiers(sourceFile)) {
        ...
        if (!isReportWriterSource && isAnalyzerV2GatewayPolicyImport(sourcePath, specifier)) {
          violations.push(`${relativePath} imports gateway policy ${specifier}`);
        }
        if (isSearchFetchProviderImport(specifier)) {
          violations.push(`${relativePath} imports search/fetch provider ${specifier}`);
      ...
      const forbiddenTextByFile = isReportWriterSource || isAggregationNarrativeContract
        ? [
          "...evidenceItemHandoff",
          "...sufficiencyIntake",
          "...sufficiencyAssessment",
  ...
  it("keeps W6 sufficiency owners isolated, redacted by default, and inside approved dependencies", () => {
    ...
    expect(sufficiencyFiles.map((filePath) => toPosix(path.relative(webRoot, filePath))).sort()).toEqual([
      "src/lib/analyzer-v2/evidence-lifecycle/sufficiency/sufficiency-assessment.ts",
    ...
    expect(existsSync(evidenceLifecycleSufficiencyAssessmentPath)).toBe(true);

    const approvedImportsByFile = new Map<string, Map<string, Set<string>>>([
      [
        toPosix(evidenceLifecycleSufficiencyIntakePath),
        new Map<string, Set<string>>([
          [
            "@/lib/analyzer-v2/evidence-lifecycle/evidence-items/evidence-item-handoff",
            new Set(["EvidenceItemHandoffDecision", "EVIDENCE_ITEM_HANDOFF_DECISION_VERSION"]),
      ...
      [
        toPosix(evidenceLifecycleSufficiencyAssessmentPath),
        new Map<string, Set<string>>([
          [
            "node:crypto",
            new Set(["createHash"]),
          ...
          [
            "@/lib/analyzer-v2/evidence-lifecycle/task-contracts/schemas",
            new Set(["EvidenceSufficiencyResultSchema"]),
          ],
          [
            "@/lib/analyzer-v2/evidence-lifecycle/task-contracts/types",
            new Set([
          ...
          [
            "@/lib/analyzer-v2/gateway/approval-records",
            new Set(["ANALYZER_V2_W6_C_CAPTAIN_APPROVAL"]),
          ],
          [
            "@/lib/analyzer-v2/gateway/policy",
            new Set(["canExecuteAnalyzerV2GatewayTask"]),
    ...
    for (const sourcePath of sufficiencyFiles) {
      ...
      const relativePath = toPosix(path.relative(webRoot, sourcePath));
      const approvedImports = approvedImportsByFile.get(toPosix(sourcePath)) ?? new Map();
      const isAssessmentSource = sourcePath === evidenceLifecycleSufficiencyAssessmentPath;
      ...
      for (const specifier of collectModuleSpecifiers(sourceFile)) {
        ...
        if (!isAssessmentSource && isAnalyzerV2GatewayPolicyImport(sourcePath, specifier)) {
          violations.push(`${relativePath} imports gateway policy ${specifier}`);
        }
        if (isClaimUnderstandingRuntimeDispatchImport(sourcePath, specifier)) {
        ...
        for (const forbiddenSpecifierFragment of [
          ...
          if (
            toPosix(specifier).includes(forbiddenSpecifierFragment) &&
            !(isAssessmentSource && forbiddenSpecifierFragment === "/gateway")
          ) {
      ...
      if (!isAssessmentSource) {
        forbiddenTexts.push("sufficiencyLlmCalled: true");
      }
      ...
      for (const location of collectDirectFetchCallLocations(sourceFile)) {
        violations.push(`W6 sufficiency owner makes direct fetch call at ${toPosix(path.relative(webRoot, location))}`);
      }
    }
    ...
    for (const publicPath of publicSurfaceFiles) {
      ...
      for (const specifier of collectModuleSpecifiers(parseSource(publicPath))) {
        if (specifier.includes("evidence-lifecycle/sufficiency/sufficiency-")) {
          violations.push(`${relativePath} imports W6 sufficiency owner ${specifier}`);
        }
      }
    }
  ...
  it("keeps W8-B internal Alpha report-result artifact bounded, internal-only, and text-free", () => {
    const violations: string[] = [];
    const requiredPaths = [
      evidenceLifecycleInternalAlphaReportResultPath,
      analyzerV2RuntimeEvidenceLifecycleInternalAlphaReportResultArtifactSinkPath,
      analyzerV2EvidenceLifecycleInternalAlphaReportResultArtifactInspectionRoutePath,
    ];
    ...
    const candidateContent = readFileSync(evidenceLifecycleInternalAlphaReportResultPath, "utf8");
    const sinkContent = readFileSync(analyzerV2RuntimeEvidenceLifecycleInternalAlphaReportResultArtifactSinkPath, "utf8");
    const routeContent = readFileSync(analyzerV2EvidenceLifecycleInternalAlphaReportResultArtifactInspectionRoutePath, "utf8");

    for (const requiredText of [
      "v2.evidence-lifecycle.internal-alpha-report-result.w8b",
      ...
      if (!candidateContent.includes(requiredText)) {
        violations.push(`W8-B candidate missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      ...
      "INTERNAL_ALPHA_REPORT_RESULT_ARTIFACT_MAX_SERIALIZED_BYTES",
    ]) {
      if (!sinkContent.includes(requiredText)) {
        violations.push(`W8-B sink missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      "checkAdminKey",
      ...
      if (!routeContent.includes(requiredText)) {
        violations.push(`W8-B route missing required text ${requiredText}`);
      }
    }
    ...
    for (const sourcePath of requiredPaths) {
      ...
      for (const specifier of collectModuleSpecifiers(sourceFile)) {
        ...
        if (
          sourcePath !== analyzerV2EvidenceLifecycleInternalAlphaReportResultArtifactInspectionRoutePath &&
      ...
      for (const location of collectDirectFetchCallLocations(sourceFile)) {
        violations.push(`W8-B file makes direct fetch call at ${toPosix(path.relative(webRoot, location))}`);
      }
    }
  ...
  it("keeps HJ18 internal report writer hidden, redacted by default, and inspection-only", () => {
    const violations: string[] = [];
    const requiredPaths = [
      evidenceLifecycleAggregationNarrativeContractPath,
      evidenceLifecycleInternalReportWriterPath,
      analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath,
      analyzerV2RuntimeEvidenceLifecycleInternalReportWriterArtifactSinkPath,
      analyzerV2EvidenceLifecycleInternalReportWriterArtifactInspectionRoutePath,
    ];
    ...
    const contractContent = readFileSync(evidenceLifecycleAggregationNarrativeContractPath, "utf8");
    const writerContent = readFileSync(evidenceLifecycleInternalReportWriterPath, "utf8");
    const ownerContent = readFileSync(analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath, "utf8");
    const sinkContent = readFileSync(analyzerV2RuntimeEvidenceLifecycleInternalReportWriterArtifactSinkPath, "utf8");
    const routeContent = readFileSync(analyzerV2EvidenceLifecycleInternalReportWriterArtifactInspectionRoutePath, "utf8");

    for (const requiredText of [
      "v2.aggregation_narrative.0",
      ...
      if (!contractContent.includes(requiredText)) {
        violations.push(`HJ18 contract missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      "v2.evidence-lifecycle.internal-report-writer.hj18",
      ...
      if (!writerContent.includes(requiredText)) {
        violations.push(`HJ18 writer missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      ...
      if (!ownerContent.includes(requiredText)) {
        violations.push(`HJ18 owner missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      ...
      "INTERNAL_REPORT_WRITER_ARTIFACT_MAX_SERIALIZED_BYTES",
    ]) {
      if (!sinkContent.includes(requiredText)) {
        violations.push(`HJ18 sink missing required text ${requiredText}`);
      }
    }
    for (const requiredText of [
      "checkAdminKey",
      ...
      if (!routeContent.includes(requiredText)) {
        violations.push(`HJ18 route missing required text ${requiredText}`);
      }
    }
    ...
    for (const sourcePath of requiredPaths) {
      ...
      for (const specifier of collectModuleSpecifiers(sourceFile)) {
        ...
        const isApprovedPromptFileRead =
          sourcePath === analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath &&
          specifier === "node:fs/promises";
        if (isCacheIoImport(specifier) && !isApprovedPromptFileRead) {
          violations.push(`${relativePath} imports IO/storage dependency ${specifier}`);
        }
        if (
          sourcePath !== analyzerV2RuntimeEvidenceLifecycleInternalReportWriterOwnerPath &&
        ...
        if (
          sourcePath !== analyzerV2EvidenceLifecycleInternalReportWriterArtifactInspectionRoutePath &&
          (specifier.startsWith("@/app") || specifier.startsWith("@/components"))
        ) {
          violations.push(`${relativePath} imports public surface ${specifier}`);
        }
      ...
      for (const location of collectDirectFetchCallLocations(sourceFile)) {
        violations.push(`HJ18 file makes direct fetch call at ${toPosix(path.relative(webRoot, location))}`);
      }
    }
    ...
    for (const forbiddenText of [
      ...
      "truthPercentagePublished: true",
    ]) {
      if (
        contractContent.includes(forbiddenText) ||
        writerContent.includes(forbiddenText) ||
        ownerContent.includes(forbiddenText) ||
        sinkContent.includes(forbiddenText) ||
        routeContent.includes(forbiddenText)
      ) {
        violations.push(`HJ18 contains forbidden text ${forbiddenText}`);
      }
    }
  ...
  it("keeps Evidence Lifecycle execution-readiness contracts inert before runtime execution", () => {
    ...
    expect(readinessFiles.map((filePath) => toPosix(path.relative(webRoot, filePath))).sort()).toEqual([
      "src/lib/analyzer-v2/evidence-lifecycle/execution-readiness/execution-readiness-denial.ts",
  ...
  it("keeps Evidence Lifecycle evidence-corpus build decision contract-only before source execution", () => {
    ...
    expect(evidenceCorpusFiles.map((filePath) => toPosix(path.relative(webRoot, filePath))).sort()).toEqual([
      "src/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/bounded-text-authorization.ts",
      "src/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/build-decision.ts",
      "src/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/evidence-corpus-extraction-readiness-denial.ts",
      "src/lib/analyzer-v2/evidence-lifecycle/evidence-corpus/evidence-corpus-shell.ts",
